...
import 'package:flutter_multicast_lock/android_multicast_lock_platform_interface.dart';
import 'package:flutter_multicast_lock/android_multicast_lock_method_channel.dart';
...
void main() {
  final AndroidMulticastLockPlatform initialPlatform =
      AndroidMulticastLockPlatform.instance;
  ...
  test('multicast lock operations', () async {
    ...
    MockAndroidMulticastLockPlatform fakePlatform =
        MockAndroidMulticastLockPlatform();
