...
void main() {
  ...
  testWidgets('multicast lock operations test', (WidgetTester tester) async {
    final FlutterMulticastLock plugin = FlutterMulticastLock();
  ...
  testWidgets('multicast lock operations with custom lockName test', (
    WidgetTester tester,
  ) async {
    final FlutterMulticastLock plugin = FlutterMulticastLock();
  ...
  testWidgets('multicast lock operations with empty lockName test', (
    WidgetTester tester,
  ) async {
    final FlutterMulticastLock plugin = FlutterMulticastLock();
